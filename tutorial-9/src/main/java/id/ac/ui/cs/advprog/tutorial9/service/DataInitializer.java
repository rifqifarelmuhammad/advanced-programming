...
public class DataInitializer {
    ...
    private List<Category> initCategory() {
        ...
        ArrayList<String> catsName = new ArrayList<>(
                Arrays.asList("Technology", "Finance", "World News", "Programming", "Movies",
    ...
    private List<Article> initArticle(List<Category> cats) {
        ...
        for (var temp = 0; temp < NUM_ARTICLES; temp++) {
            var a = new Article(randomSentence(words, 2, 5), randomSentence(words, 1000, 5000),
                    cats.get(random.nextInt(catsSize)), randomDate());
            arts.add(a);
    ...
    private void initArticleView(List<Article> arts) {
        ...
        while (createdArticlesView < NUM_ARTICLES_VIEW) {
            ...
            for (var temp = 0; temp < articleToday; temp++) {
                ...
                var articleView = new ArticleView(randomIpAddress(), randomTimeToday,
                        arts.get(random.nextInt(arts.size())));
